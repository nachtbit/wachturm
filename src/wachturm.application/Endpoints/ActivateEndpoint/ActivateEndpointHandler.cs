...
namespace wachturm.Application.Endpoints.ActivateEndpoint;

public sealed class ActivateEndpointHandler
{
    private readonly IMonitoredEndpointRepository _repository;

    public ActivateEndpointHandler(IMonitoredEndpointRepository repository)
    {
